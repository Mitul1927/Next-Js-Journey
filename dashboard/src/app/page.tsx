...
const Home = () => {
  return (
    <div className='min-h-screen bg-gradient-to-br from-blue-50 from-10% via-indigo-100 via-30% to-emerald-500 to-90% flex flex-col items-center justify-center p-6'>
